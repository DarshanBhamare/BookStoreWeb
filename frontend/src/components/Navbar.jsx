        ...
        <div className="navbar bg-base-100 shadow-sm dark:bg-slate-900 dark:text-white">
          ...
          <div className="navbar-end space-x-3">
            ...
            </label>
            {
              ...
              <a className='bg-black text-white px-3 py-2 rounded-md hover:bg-slate:1000 duration-300 cursor-pointer ' onClick={()=>document.getElementById("my_modal_1").showModal()}>Login</a>
              <Login/>
            </div> 
            }
